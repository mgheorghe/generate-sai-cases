    ...
    for attribute in mandatory_attributes.keys():
        ...
        if 'type' in mandatory_attributes[attribute].keys():
            if 'sai_uint16_t' == mandatory_attributes[attribute]['type']:
                ...
                attributes.append('10')
            elif 'sai_bridge_type_t' == mandatory_attributes[attribute]['type']: #Fail: SAI_STATUS_NOT_IMPLEMENTED
            ...
            elif "sai_tam_transport_type_t" == mandatory_attributes[attribute]['type']: #Fail# SAI_STATUS_NOT_SUPPORTED
                attributes.append('SAI_TAM_TRANSPORT_TYPE_TCP')
            elif "sai_s8_list_t" == mandatory_attributes[attribute]['type']:  #Error: not sure of the values
            ...
            elif "sai_dtel_event_type_t" == mandatory_attributes[attribute]['type']: #Fail: SAI_STATUS_NOT_SUPPORTED
            ...
            elif "sai_qos_map_list_t" == mandatory_attributes[attribute]['type']: #Error: not sure of the values
                attributes.append('2:10,11')
            elif "sai_u32_list_t" == mandatory_attributes[attribute]['type']: #Error: not sure of the values
                attributes.append('2:10,11')
            elif "sai_acl_stage_t" == mandatory_attributes[attribute]['type']:
                attributes.append('SAI_ACL_STAGE_INGRESS')
            elif "bool" == mandatory_attributes[attribute]['type']:  # Error: fails for true and false
            ...
            elif "sai_macsec_direction_t" == mandatory_attributes[attribute]['type']: #Fail: SAI_STATUS_NOT_IMPLEMENTED
            ...
            elif "sai_my_sid_entry_endpoint_behavior_t" == mandatory_attributes[attribute]['type']: #fails due to unknown reason
                attributes.append('SAI_MY_SID_ENTRY_ENDPOINT_BEHAVIOR_E')  
            elif "sai_next_hop_group_map_type_t" == mandatory_attributes[attribute]['type']: #fails due to unknown reason
                attributes.append('SAI_NEXT_HOP_GROUP_MAP_TYPE_FORWARDING_CLASS_TO_INDEX')  
            elif "sai_hostif_user_defined_trap_type_t" == mandatory_attributes[attribute]['type']: 
            ...
            elif "sai_tunnel_type_t" == mandatory_attributes[attribute]['type']: #Fail: SAI_STATUS_NOT_IMPLEMENTED
                attributes.append('SAI_TUNNEL_TYPE_IPINIP')  
            elif "sai_acl_stage_t" == mandatory_attributes[attribute]['type']: 
                attributes.append('SAI_ACL_STAGE_INGRESS')  
            elif "sai_fdb_entry_type_t" == mandatory_attributes[attribute]['type']:  #fails due to unknown reason
            ...
            elif "sai_isolation_group_type_t" == mandatory_attributes[attribute]['type']: 
                attributes.append('SAI_ISOLATION_GROUP_TYPE_PORT') 
            elif "sai_macsec_direction_t" == mandatory_attributes[attribute]['type']: 
                attributes.append('SAI_MACSEC_DIRECTION_EGRESS') 
            elif "sai_hostif_trap_type_t" == mandatory_attributes[attribute]['type']:  #fails due to unknown reason
                attributes.append('SAI_HOSTIF_TRAP_TYPE_START') 
            elif "sai_packet_action_t" == mandatory_attributes[attribute]['type']:  #fails due to unknown reason
            ...
            elif "sai_switch_hardware_access_bus_t" == mandatory_attributes[attribute]['type']: 
