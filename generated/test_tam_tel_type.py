...
class TestSaiTamTelType:
    ...
    def test_tam_tel_type_create(self, npu):
        ...
        commands = [{'name': 'tam_report_1', 'op': 'create', 'type': 'SAI_OBJECT_TYPE_TAM_REPORT', 'attributes': ['SAI_TAM_REPORT_ATTR_TYPE', 'SAI_TAM_REPORT_TYPE_SFLOW']}, {'name': 'tam_tel_type_1', 'op': 'create', 'type': 'SAI_OBJECT_TYPE_TAM_TEL_TYPE', 'attributes': ['SAI_TAM_TEL_TYPE_ATTR_TAM_TELEMETRY_TYPE', 'SAI_TAM_TELEMETRY_TYPE_NE', 'SAI_TAM_TEL_TYPE_ATTR_REPORT_ID', '$tam_report_1']}]
    ...
    def test_tam_tel_type_remove(self, npu):
        ...
        commands = [{'name': 'tam_tel_type_1', 'op': 'remove'}, {'name': 'tam_report_1', 'op': 'remove'}]
