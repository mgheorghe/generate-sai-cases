...
class TestSaiHostifTableEntry:
    ...
    def test_hostif_table_entry_remove(self, npu):
        ...
        commands = [{'name': 'hostif_table_entry_1', 'op': 'remove'}, {'name': 'hostif_1', 'op': 'remove'}, {'name': 'hostif_trap_1', 'op': 'remove'}, {'name': 'port_1', 'op': 'remove'}]
