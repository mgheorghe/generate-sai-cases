...
class TestSaiAclTableGroupMember:
    ...
    @pytest.mark.dependency(
        name='test_sai_acl_table_group_member_attr_acl_table_chain_group_id_set'
    )
    ...
    @pytest.mark.dependency(
        depends=['test_sai_acl_table_group_member_attr_acl_table_chain_group_id_set']
    )
    ...
    def test_acl_table_group_member_remove(self, npu):
        commands = [
            {'name': 'acl_table_group_member_1', 'op': 'remove'},
            {'name': 'acl_table_1', 'op': 'remove'},
            {'name': 'acl_table_group_1', 'op': 'remove'},
        ]
