...
class TestSaiHostif:
    ...
    def test_hostif_create(self, npu):
        ...
        commands = [{'name': 'port_1', 'op': 'create', 'type': 'SAI_OBJECT_TYPE_PORT', 'attributes': ['SAI_PORT_ATTR_HW_LANE_LIST', '2:10,11', 'SAI_PORT_ATTR_SPEED', '10']}, {'name': 'hostif_1', 'op': 'create', 'type': 'SAI_OBJECT_TYPE_HOSTIF', 'attributes': ['SAI_HOSTIF_ATTR_TYPE', 'SAI_HOSTIF_TYPE_NETDEV', 'SAI_HOSTIF_ATTR_OBJ_ID', '$port_1', 'SAI_HOSTIF_ATTR_NAME', 'inbound', 'SAI_HOSTIF_ATTR_GENETLINK_MCGRP_NAME', 'inbound']}]
    ...
    def test_hostif_remove(self, npu):
        ...
        commands = [{'name': 'hostif_1', 'op': 'remove'}, {'name': 'port_1', 'op': 'remove'}]
