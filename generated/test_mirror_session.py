...
class TestSaiMirrorSession:
    ...
    def test_mirror_session_create(self, npu):
        ...
        commands = [{'name': 'port_1', 'op': 'create', 'type': 'SAI_OBJECT_TYPE_PORT', 'attributes': ['SAI_PORT_ATTR_HW_LANE_LIST', '2:10,11', 'SAI_PORT_ATTR_SPEED', '10']}, {'name': 'mirror_session_1', 'op': 'create', 'type': 'SAI_OBJECT_TYPE_MIRROR_SESSION', 'attributes': ['SAI_MIRROR_SESSION_ATTR_TYPE', 'SAI_MIRROR_SESSION_TYPE_LOCAL', 'SAI_MIRROR_SESSION_ATTR_MONITOR_PORT', '$port_1', 'SAI_MIRROR_SESSION_ATTR_ERSPAN_ENCAPSULATION_TYPE', 'SAI_ERSPAN_ENCAPSULATION_TYPE_MIRROR_L3_GRE_TUNNEL', 'SAI_MIRROR_SESSION_ATTR_IPHDR_VERSION', '1', 'SAI_MIRROR_SESSION_ATTR_TOS', '1', 'SAI_MIRROR_SESSION_ATTR_SRC_IP_ADDRESS', '180.0.0.1', 'SAI_MIRROR_SESSION_ATTR_DST_IP_ADDRESS', '180.0.0.1', 'SAI_MIRROR_SESSION_ATTR_SRC_MAC_ADDRESS', '00:00:B1:AE:C5:00', 'SAI_MIRROR_SESSION_ATTR_DST_MAC_ADDRESS', '00:00:B1:AE:C5:00', 'SAI_MIRROR_SESSION_ATTR_GRE_PROTOCOL_TYPE', '10', 'SAI_MIRROR_SESSION_ATTR_MONITOR_PORTLIST', 'sai_object_list_t', 'SAI_MIRROR_SESSION_ATTR_UDP_SRC_PORT', '10', 'SAI_MIRROR_SESSION_ATTR_UDP_DST_PORT', '10']}]
    ...
    def test_mirror_session_remove(self, npu):
        ...
        commands = [{'name': 'mirror_session_1', 'op': 'remove'}, {'name': 'port_1', 'op': 'remove'}]
