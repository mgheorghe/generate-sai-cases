...
class TestSaiOutboundRoutingEntry:
    ...
    @pytest.mark.dependency(
        name='test_sai_outbound_routing_entry_attr_meter_policy_en_set'
    )
    ...
    @pytest.mark.dependency(
        depends=['test_sai_outbound_routing_entry_attr_meter_policy_en_set']
    )
    ...
    @pytest.mark.dependency(
        depends=['test_sai_outbound_routing_entry_attr_meter_class_set']
    )
