...
class TestSaiBridgePort:
    ...
    def test_bridge_port_remove(self, npu):
        ...
        commands = [{'name': 'bridge_port_1', 'op': 'remove'}, {'name': 'tunnel_1', 'op': 'remove'}, {'name': 'router_interface_1', 'op': 'remove'}, {'name': 'bridge_1', 'op': 'remove'}, {'name': 'vlan_1', 'op': 'remove'}, {'name': 'virtual_router_1', 'op': 'remove'}, {'name': 'port_1', 'op': 'remove'}]
