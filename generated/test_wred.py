...
class TestSaiWred:
    ...
    @pytest.mark.dependency(
        depends=['test_sai_wred_attr_ecn_green_min_threshold_64_set']
    )
    ...
    @pytest.mark.dependency(
        depends=['test_sai_wred_attr_ecn_green_max_threshold_64_set']
    )
    ...
    @pytest.mark.dependency(
        depends=['test_sai_wred_attr_ecn_yellow_min_threshold_64_set']
    )
    ...
    @pytest.mark.dependency(
        depends=['test_sai_wred_attr_ecn_yellow_max_threshold_64_set']
    )
    ...
    @pytest.mark.dependency(
        name='test_sai_wred_attr_ecn_color_unaware_min_threshold_64_set'
    )
    ...
    @pytest.mark.dependency(
        depends=['test_sai_wred_attr_ecn_color_unaware_min_threshold_64_set']
    )
    ...
    @pytest.mark.dependency(
        name='test_sai_wred_attr_ecn_color_unaware_max_threshold_64_set'
    )
    ...
    @pytest.mark.dependency(
        depends=['test_sai_wred_attr_ecn_color_unaware_max_threshold_64_set']
    )
