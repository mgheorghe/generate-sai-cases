...
class TestSaiOutboundCaToPaEntry:
    ...
    @pytest.mark.dependency(
        name='test_sai_outbound_ca_to_pa_entry_attr_meter_class_set'
    )
    ...
    @pytest.mark.dependency(
        depends=['test_sai_outbound_ca_to_pa_entry_attr_meter_class_set']
    )
    ...
    @pytest.mark.dependency(
        name='test_sai_outbound_ca_to_pa_entry_attr_meter_class_override_set'
    )
    ...
    @pytest.mark.dependency(
        depends=['test_sai_outbound_ca_to_pa_entry_attr_meter_class_override_set']
    )
