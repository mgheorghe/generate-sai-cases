...
class TestSaiNextHopGroup:
    ...
    def test_next_hop_group_remove(self, npu):
        ...
        commands = [{'name': 'next_hop_group_1', 'op': 'remove', 'type': 'SAI_OBJECT_TYPE_NEXT_HOP_GROUP', 'attributes': ['SAI_NEXT_HOP_GROUP_ATTR_TYPE', 'SAI_NEXT_HOP_GROUP_TYPE_DYNAMIC_UNORDERED_ECMP']}]
