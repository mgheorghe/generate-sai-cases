...
class TestSaiDashAclRule:
    ...
    def test_dash_acl_rule_remove(self, dpu):
        ...
        commands = [{'name': 'dash_acl_rule_1', 'op': 'remove'}, {'name': 'dash_acl_group_1', 'op': 'remove'}]
