...
class TestSaiTamEventAction:
    ...
    def test_tam_event_action_create(self, npu):
        ...
        commands = [{'name': 'tam_report_1', 'op': 'create', 'type': 'SAI_OBJECT_TYPE_TAM_REPORT', 'attributes': ['SAI_TAM_REPORT_ATTR_TYPE', 'SAI_TAM_REPORT_TYPE_SFLOW']}, {'name': 'tam_event_action_1', 'op': 'create', 'type': 'SAI_OBJECT_TYPE_TAM_EVENT_ACTION', 'attributes': ['SAI_TAM_EVENT_ACTION_ATTR_REPORT_TYPE', '$tam_report_1']}]
    ...
    def test_tam_event_action_remove(self, npu):
        ...
        commands = [{'name': 'tam_event_action_1', 'op': 'remove'}, {'name': 'tam_report_1', 'op': 'remove'}]
