...
class TestSaiDtelQueueReport:
    ...
    def test_dtel_queue_report_remove(self, npu):
        ...
        commands = [{'name': 'dtel_queue_report_1', 'op': 'remove'}, {'name': 'queue_1', 'op': 'remove'}, {'name': 'scheduler_group_1', 'op': 'remove'}, {'name': 'port_1', 'op': 'remove'}]
