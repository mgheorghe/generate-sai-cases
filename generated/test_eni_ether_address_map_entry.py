...
class TestSaiEniEtherAddressMapEntry:
    ...
    def test_eni_ether_address_map_entry_create(self, dpu):
        ...
        commands = [{'name': 'eni_ether_address_map_entry_1', 'op': 'create', 'type': 'SAI_OBJECT_TYPE_ENI_ETHER_ADDRESS_MAP_ENTRY', 'attributes': [], 'key': {'switch_id': '$SWITCH_ID', 'address': 'TODO'}}]
    ...
    def test_eni_ether_address_map_entry_remove(self, dpu):
        ...
        commands = [{'name': 'eni_ether_address_map_entry_1', 'key': {'switch_id': '$SWITCH_ID', 'address': 'TODO'}, 'op': 'remove'}]
