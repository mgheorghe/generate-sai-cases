...
class TestSaiRouterInterface:
    ...
    def test_router_interface_remove(self, npu):
        ...
        commands = [{'name': 'router_interface_1', 'op': 'remove'}, {'name': 'bridge_1', 'op': 'remove'}, {'name': 'vlan_1', 'op': 'remove'}, {'name': 'port_1', 'op': 'remove'}, {'name': 'virtual_router_1', 'op': 'remove'}]
