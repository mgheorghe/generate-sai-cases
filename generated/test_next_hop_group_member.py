...
class TestSaiNextHopGroupMember:
    ...
    def test_next_hop_group_member_remove(self, npu):
        ...
        commands = [{'name': 'next_hop_group_member_1', 'op': 'remove'}, {'name': 'next_hop_1', 'op': 'remove'}, {'name': 'srv6_sidlist_1', 'op': 'remove'}, {'name': 'tunnel_1', 'op': 'remove'}, {'name': 'router_interface_1', 'op': 'remove'}, {'name': 'bridge_1', 'op': 'remove'}, {'name': 'vlan_1', 'op': 'remove'}, {'name': 'port_1', 'op': 'remove'}, {'name': 'virtual_router_1', 'op': 'remove'}, {'name': 'next_hop_group_1', 'op': 'remove'}]
