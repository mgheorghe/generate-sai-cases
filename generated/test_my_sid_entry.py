...
class TestSaiMySidEntry:
    ...
    def test_my_sid_entry_create(self, npu):
        ...
        commands = [{'name': 'my_sid_entry_1', 'op': 'create', 'type': 'SAI_OBJECT_TYPE_MY_SID_ENTRY', 'attributes': ['SAI_MY_SID_ENTRY_ATTR_ENDPOINT_BEHAVIOR', 'SAI_MY_SID_ENTRY_ENDPOINT_BEHAVIOR_E'], 'key': {'switch_id': '$SWITCH_ID', 'vr_id': 'TODO', 'locator_block_len': 'TODO', 'locator_node_len': 'TODO', 'function_len': 'TODO', 'args_len': 'TODO', 'sid': 'TODO'}}]
    ...
    def test_my_sid_entry_remove(self, npu):
        ...
        commands = [{'name': 'my_sid_entry_1', 'key': {'switch_id': '$SWITCH_ID', 'vr_id': 'TODO', 'locator_block_len': 'TODO', 'locator_node_len': 'TODO', 'function_len': 'TODO', 'args_len': 'TODO', 'sid': 'TODO'}, 'op': 'remove'}]
