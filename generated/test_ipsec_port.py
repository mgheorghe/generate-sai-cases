...
class TestSaiIpsecPort:
    ...
    def test_ipsec_port_create(self, npu):
        ...
        commands = [{'name': 'port_1', 'op': 'create', 'type': 'SAI_OBJECT_TYPE_PORT', 'attributes': ['SAI_PORT_ATTR_HW_LANE_LIST', '2:10,11', 'SAI_PORT_ATTR_SPEED', '10']}, {'name': 'ipsec_port_1', 'op': 'create', 'type': 'SAI_OBJECT_TYPE_IPSEC_PORT', 'attributes': ['SAI_IPSEC_PORT_ATTR_PORT_ID', '$port_1', 'SAI_IPSEC_PORT_ATTR_NATIVE_VLAN_ID', '10']}]
    ...
    def test_ipsec_port_remove(self, npu):
        ...
        commands = [{'name': 'ipsec_port_1', 'op': 'remove'}, {'name': 'port_1', 'op': 'remove'}]
