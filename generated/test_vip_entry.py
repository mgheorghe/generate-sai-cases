...
class TestSaiVipEntry:
    ...
    def test_vip_entry_create(self, dpu):
        ...
        commands = [{'name': 'vip_entry_1', 'op': 'create', 'type': 'SAI_OBJECT_TYPE_VIP_ENTRY', 'attributes': [], 'key': {'switch_id': '$SWITCH_ID', 'vip': 'TODO'}}]
    ...
    def test_vip_entry_remove(self, dpu):
        ...
        commands = [{'name': 'vip_entry_1', 'key': {'switch_id': '$SWITCH_ID', 'vip': 'TODO'}, 'op': 'remove'}]
