...
class TestSaiPortConnector:
    ...
    def test_port_connector_create(self, npu):
        ...
        commands = [{'name': 'port_1', 'op': 'create', 'type': 'SAI_OBJECT_TYPE_PORT', 'attributes': ['SAI_PORT_ATTR_HW_LANE_LIST', '2:10,11', 'SAI_PORT_ATTR_SPEED', '10']}, {'name': 'port_connector_1', 'op': 'create', 'type': 'SAI_OBJECT_TYPE_PORT_CONNECTOR', 'attributes': ['SAI_PORT_CONNECTOR_ATTR_SYSTEM_SIDE_PORT_ID', '$port_1', 'SAI_PORT_CONNECTOR_ATTR_LINE_SIDE_PORT_ID', '$port_1']}]
    ...
    def test_port_connector_remove(self, npu):
        ...
        commands = [{'name': 'port_connector_1', 'op': 'remove'}, {'name': 'port_1', 'op': 'remove'}]
