...
class TestSaiInsegEntry:
    ...
    def test_inseg_entry_create(self, npu):
        ...
        commands = [{'name': 'inseg_entry_1', 'op': 'create', 'type': 'SAI_OBJECT_TYPE_INSEG_ENTRY', 'attributes': [], 'key': {'switch_id': '$SWITCH_ID', 'label': 'TODO'}}]
    ...
    def test_inseg_entry_remove(self, npu):
        ...
        commands = [{'name': 'inseg_entry_1', 'key': {'switch_id': '$SWITCH_ID', 'label': 'TODO'}, 'op': 'remove'}]
