...
class TestSaiVlan:
    ...
    def test_sai_vlan_attr_stp_instance_get(self, npu):
        ...
        r_value = results[0][0].value()
        print(r_value)
        assert r_value == 'SAI_SWITCH_ATTR_DEFAULT_STP_INST_ID', (
    ...
    def test_sai_vlan_attr_ipv4_mcast_lookup_key_type_get(self, npu):
        ...
        r_value = results[0][0].value()
        print(r_value)
        assert r_value == 'SAI_VLAN_MCAST_LOOKUP_KEY_TYPE_MAC_DA', (
    ...
    @pytest.mark.dependency(
        name='test_sai_vlan_attr_unknown_non_ip_mcast_output_group_id_set'
    )
    ...
    @pytest.mark.dependency(
        name='test_sai_vlan_attr_unknown_ipv4_mcast_output_group_id_set'
    )
    ...
    @pytest.mark.dependency(
        name='test_sai_vlan_attr_unknown_ipv6_mcast_output_group_id_set'
    )
    ...
    @pytest.mark.dependency(
        name='test_sai_vlan_attr_unknown_linklocal_mcast_output_group_id_set'
    )
        ...
        commands = [
            {
                'name': 'vlan_1',
                'op': 'set',
                'attributes': ['SAI_VLAN_ATTR_INGRESS_ACL', 'null'],
            }
        ]
        results = [*npu.process_commands(commands)]
        print('======= SAI commands RETURN values get =======')
        ...
        commands = [
            {
                'name': 'vlan_1',
                'op': 'set',
                'attributes': ['SAI_VLAN_ATTR_EGRESS_ACL', 'null'],
            }
        ]
        results = [*npu.process_commands(commands)]
        print('======= SAI commands RETURN values get =======')
    ...
    @pytest.mark.dependency(
        name='test_sai_vlan_attr_unknown_unicast_flood_control_type_set'
    )
    ...
    def test_sai_vlan_attr_unknown_unicast_flood_control_type_get(self, npu):
        ...
        r_value = results[0][0].value()
        print(r_value)
        assert r_value == 'SAI_VLAN_FLOOD_CONTROL_TYPE_ALL', (
            'Get error, expected SAI_VLAN_FLOOD_CONTROL_TYPE_ALL but got %s' % r_value
        )
        ...
        commands = [
            {
                'name': 'vlan_1',
                'op': 'set',
                'attributes': ['SAI_VLAN_ATTR_UNKNOWN_UNICAST_FLOOD_GROUP', 'null'],
            }
        ]
        results = [*npu.process_commands(commands)]
        print('======= SAI commands RETURN values get =======')
    ...
    @pytest.mark.dependency(
        name='test_sai_vlan_attr_unknown_multicast_flood_control_type_set'
    )
        ...
        commands = [
            {
                'name': 'vlan_1',
                'op': 'set',
                'attributes': ['SAI_VLAN_ATTR_UNKNOWN_MULTICAST_FLOOD_GROUP', 'null'],
            }
        ]
        results = [*npu.process_commands(commands)]
        print('======= SAI commands RETURN values get =======')
        ...
        commands = [
            {
                'name': 'vlan_1',
                'op': 'set',
                'attributes': ['SAI_VLAN_ATTR_BROADCAST_FLOOD_GROUP', 'null'],
            }
        ]
        results = [*npu.process_commands(commands)]
        print('======= SAI commands RETURN values get =======')
