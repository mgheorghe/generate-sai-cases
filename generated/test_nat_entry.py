...
class TestSaiNatEntry:
    ...
    def test_nat_entry_create(self, npu):
        ...
        commands = [{'name': 'nat_entry_1', 'op': 'create', 'type': 'SAI_OBJECT_TYPE_NAT_ENTRY', 'attributes': [], 'key': {'switch_id': '$SWITCH_ID', 'vr_id': 'TODO', 'nat_type': 'TODO', 'data': 'TODO'}}]
    ...
    def test_nat_entry_remove(self, npu):
        ...
        commands = [{'name': 'nat_entry_1', 'key': {'switch_id': '$SWITCH_ID', 'vr_id': 'TODO', 'nat_type': 'TODO', 'data': 'TODO'}, 'op': 'remove'}]
